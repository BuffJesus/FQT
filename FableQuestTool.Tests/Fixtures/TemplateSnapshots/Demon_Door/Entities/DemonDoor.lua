-- DemonDoor.lua
-- Entity script for MyDemonDoorQuest
...
function Init(questObject, meObject)
    Quest = questObject
    Me = meObject
    Quest:Log("DemonDoor: Init called")
    Me:MakeBehavioral()
    Me:AcquireControl()
end
...
function Main(questObject, meObject)
    Quest = questObject
    Me = meObject
    Quest:Log("DemonDoor: Main started")
    ...
    hasItem = true
            ...
            if hasItem then
                ...
                Me:SpeakAndWait("The door is pleased... it opens.")
                Quest:SetStateBool("QuestCompleted", true)
                break
            else
                Me:SpeakAndWait("I require an offering...")
            end
        end
